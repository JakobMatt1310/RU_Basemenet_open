...
class Tournament():
    ...
    def __init__(self, tour_name="", tour_address="", start_date="", end_date="", game_count="", teams_submitted="", game_id="", player_nr="", game_type="", leg_nr="", player_id="", q_points=""):
